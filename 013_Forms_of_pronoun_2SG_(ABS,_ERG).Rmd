---
title: Forms of pronoun 2SG (ABS, ERG)
author: Ilya Sadakov
...
db <- read_csv('data/database.csv') %>% filter(feature_id == 13)
villages <- read_csv('data/villages.csv')
```

Forms of the personal pronoun 2SG ('you' singular) — absolutive and ergative
