...
db <- read_csv('data/database.csv') %>% filter(feature_id == 3)
villages <- read_csv('data/villages.csv')
```

Is it possible to add or to eliminate vowel in ergative marker (depending on the form of the first reaction)?
