---
title: Marking of topological relation ‘from the top of’
...
We elicited the context ‘The frog got off the rock’. The map shows the marking on the noun ‘rock’. The attested variants include: *-Vːla* / *-Vːlɨ* / *-aːl* (long vowel), *-Vla* / *-Vlɨ* (short vowel) and *-aja* (attested only in Ikhrek).
