---
title: Plural form of the noun ‘goat’
...
The singular absolutive form is either *cʼihʲ*, either *cʼij* (see feature @). The plural absolutive form can be regular: *cʼiher*, *cʼihe* and *cʼijmar* (and their phonetic variants), or irregular: *cʼuhuler* (and its phonetic variants). In some villages only regular forms are present, in some - both of them, and in the rest - the irregular variant is the only variant attested.
