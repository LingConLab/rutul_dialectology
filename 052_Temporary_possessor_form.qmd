...
lexeme_data <- db |> 
  filter(feature_id == 52) |>  # First filter by feature_id
  filter(feature_lexeme == "‘who’") |>  # Then filter by feature_lexeme
...
lexeme_data <- db |> 
  filter(feature_id == 52) |>  # First filter by feature_id
  filter(feature_lexeme == "‘I’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
