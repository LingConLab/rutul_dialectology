---
title: Marking of topological relation ‘from in contact with’
...
We elicited the context ‘Musa took the painting off the wall’. The map shows the case marking on the noun ‘wall’. The attested variants include: *-kla* / *-kʲla* / *-klʲa*, *-ka* (attested only in Ikhrek), *-aːla* (attested only in Khnov) and *-qla* / *-χla*.
