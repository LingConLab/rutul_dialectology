---
title: Basic forms of the second person pronoun
author: Ilya Sadakov
date: 'Last update: `r lubridate::make_datetime(year = 2023, month = 4, day = 16)`'
output:
  html_document:
...
Two maps show the absolutive and the ergative forms of the second person singular pronoun 'you.sg'.


## you.ABS {.tabset .tabset-fade .tabset-pills}

### Map

```{r}
db |> 
  filter(feature_lexeme == 'you.ABS')  |>
  filter(!is.na(value),
         value != 'NO DATA') |>
...
## you.ERG {.tabset .tabset-fade .tabset-pills}

### Map

```{r}
db |> 
  filter(feature_lexeme == 'you.ERG')  |>
  filter(!is.na(value),
         value != 'NO DATA') |>
  mutate(value = str_split(value, ' ; ')) |> 
  unnest_longer(value) |> 
