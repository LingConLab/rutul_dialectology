...
We elicited the context ‘I didn't tell him anything’. The map shows the marking on the pronoun ‘him’ (the addressee). The attested variants include: *-χda* (attested only in Kiche) and *-da* / *-de* / *-dɨ* / *-dda* / *-d* (elsewhere).
...
feature_data <- db |> 
  filter(feature_id == 30) |>  # Filter by feature_id
