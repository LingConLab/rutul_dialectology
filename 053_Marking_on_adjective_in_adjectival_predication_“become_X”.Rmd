...
## ‘The apple became red’ {.tabset .tabset-fade .tabset-pills}

### Map

```{r}
db |> 
  filter(feature_lexeme == '‘The apple became red’')  |>
  filter(!is.na(value),
         value != 'NO DATA') |>
...
## ‘The woman became good’ {.tabset .tabset-fade .tabset-pills}

### Map

```{r}
db |> 
  filter(feature_lexeme == '‘The woman became good’')  |>
  filter(!is.na(value),
         value != 'NO DATA') |>
  mutate(value = str_split(value, ' ; ')) |> 
  unnest_longer(value) |> 
