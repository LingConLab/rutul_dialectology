---
title: Unintentional agent marking
author: Kostya Filatov
date: 'Last update: `r lubridate::make_datetime(year = 2024, month = 2, day = 18)`'
output:
  html_document:
...
We elicited the two contexts ‘I (unintentionally) broke a cup’ and 'Rasul (unintentionally) broke a screwdriver'. The maps show the marking on the 'I' pronoun and the proper name ‘Rasul’. The attested variants include: case markers *-da / -dɨ / -dːa / -daː* and *-dɨgɨr / -dɨgɨ / -dɨga* (the latter attested only in Khnov).


## Rasul {.tabset .tabset-fade .tabset-pills}

### Map

```{r}
db |> 
  filter(feature_lexeme == 'Rasul')  |>
  filter(!is.na(value),
         value != 'NO DATA') |>
