...
We asked a context ‘There are a lot of fish in the water’, and this map shows the variation of oblique stems of the word ‘water’, forms attested: *xid-* / *šid-* (Ikhrek, Khnov, Rutul, Kufa and Kiche) and *xi-* (Shinaz and partly Kala), *xij-* (elsewhere). To see the diffrences in case marking in this context, see @feature.
