...
There can be a hortative particle which conveys an appeal ‘Let’s go!’ which may or may not be used to form hortatives (see Map Hortative marking). In some dialects, the imperative of the verb ‘go’ can be used.
