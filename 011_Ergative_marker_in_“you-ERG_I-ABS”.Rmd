---
title: Ergative marker in “you-ERG I-ABS”
author: Ilya Sadakov
...
db <- read_csv('data/database.csv') |> filter(feature_id == 11)
villages <- read_csv('data/villages.csv')
```

In the context with the ergative 2nd person participant and the absolutive 1st person participant ('you-ERG I-ABS'), is the ergative case marker zero, overt, or it varies?
