...
We elicited two contexts with predicative possessors: ‘Fatima has two children’ (affirmative) and ‘Rasul does not have a car’ (negative). The maps show the markers used on the possessor in these contexts, including *-χda*, *-χdɨ* or *-d* (attested with only one consultant, in Amsar).
