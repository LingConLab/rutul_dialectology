...
We elicited the two contexts ‘I (unintentionally) broke a cup’ and ‘Rasul (unintentionally) broke a screwdriver’. The maps show the case marking on the pronoun ‘I’ and the proper name ‘Rasul’. The attested variants include: *-da* / *-dɨ* / *-dːa* / *-daː* and *-dɨgɨr* / *-dɨgɨ* / *-dɨga* (the latter attested only in Khnov).
