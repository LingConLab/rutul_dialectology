---
title: Marking of topological relation ‘out of’
...
We elicited the context ‘I went out of the house’. The map shows the marking on the noun ‘house’. The attested variants include: *-aː*, *-a* (attested with only one consultant, in Dzhilikhur), *-gɨr* (attested only in Khnov) and *-aːla* (attested with only one consultant, in Shinaz).
