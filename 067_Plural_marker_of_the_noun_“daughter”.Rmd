...
date: 'Last update: `r lubridate::make_datetime(year = 2023, month = 11, day = 14)`'
output:
  html_document:
...
The irregular plural marker of the noun rɨš 'daughter' demonstrate the following variation pattern: -ib / -ɨb is found in Myukhrek and Dzhilikhur, -bir — in Khnov, -bi / -bɨ — in Amsar, -be is the most common variant which are found elsewhere.
