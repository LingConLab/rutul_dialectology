---
title: Marking of topological relation ‘in contact on top of’
...
We elicited the context ‘There is a stain on the table’. The map shows the case marking on the noun ‘table’. The attested variants include: *-k* / *-kʲ*, *-a*, *-aj* (in Ikhrek) and *-xde* (attested with only one consultant, in Kiche).
