---
title: Imperative interjection “here you are, take it!”
author: Ilya Sadakov
date: .na.character
output:
  html_document:
...
The map shows the form of the imperative interjection used when passing something to the addressee.


## here, take money {.tabset .tabset-fade .tabset-pills}

### Map

```{r}
db |> 
  filter(feature_lexeme == 'here, take money')  |>
  filter(!is.na(value),
         value != 'NO DATA') |>
...
## here, bread for you {.tabset .tabset-fade .tabset-pills}

### Map

```{r}
db |> 
  filter(feature_lexeme == 'here, bread for you')  |>
  filter(!is.na(value),
         value != 'NO DATA') |>
  mutate(value = str_split(value, ' ; ')) |> 
  unnest_longer(value) |> 
