...
These maps show how the standard of comparison is marked. We asked two contexts: ‘Mather is kinder than father’ and ‘A pear is sweeter than apple’ with standards of comparison ‘father’ and ‘pear’ respectfully. Attested markers are the following: *-ɨːla* / *-iːla* (and other phonetic variants), *-qa* / *-qaʔ*, *-qana* (attested once, in Kiche), *-χda* (attested once, in Dzhilikhur).
