...
## ‘The apple is red’ {.tabset .tabset-fade .tabset-pills}

### Map

```{r}
db |> 
  filter(feature_lexeme == '‘The apple is red’')  |>
  filter(!is.na(value),
         value != 'NO DATA') |>
...
## ‘The woman is good’ {.tabset .tabset-fade .tabset-pills}

### Map

```{r}
db |> 
  filter(feature_lexeme == '‘The woman is good’')  |>
  filter(!is.na(value),
         value != 'NO DATA') |>
  mutate(value = str_split(value, ' ; ')) |> 
  unnest_longer(value) |> 
