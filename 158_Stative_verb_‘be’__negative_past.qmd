---
title: "Stative verb ‘be’: negative past"
...
In the negative past, the stative verbs take the past tense suffix *-ij* in the majority of varieties (e.g. *diš-ij* ‘was not’). In Khnov, the past tense suffix is *-na* (e.g. *diš-na*).
...
lexeme_data <- db |> 
  filter(feature_id == 158) |>  # First filter by feature_id
