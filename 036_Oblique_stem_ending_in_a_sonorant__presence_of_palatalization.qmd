---
title: "Oblique stem ending in a sonorant: presence of palatalization"
...
lexeme_data <- db |> 
  filter(feature_id == 36) |>  # First filter by feature_id
  filter(feature_lexeme == "‘moon’") |>  # Then filter by feature_lexeme
...
lexeme_data <- db |> 
  filter(feature_id == 36) |>  # First filter by feature_id
  filter(feature_lexeme == "‘snow’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |> 
  filter(feature_id == 36) |>  # First filter by feature_id
  filter(feature_lexeme == "‘chicken’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |> 
  filter(feature_id == 36) |>  # First filter by feature_id
  filter(feature_lexeme == "‘ice’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |> 
  filter(feature_id == 36) |>  # First filter by feature_id
  filter(feature_lexeme == "‘sheaf’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |> 
  filter(feature_id == 36) |>  # First filter by feature_id
  filter(feature_lexeme == "‘cat’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |> 
  filter(feature_id == 36) |>  # First filter by feature_id
  filter(feature_lexeme == "‘eagle’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |> 
  filter(feature_id == 36) |>  # First filter by feature_id
  filter(feature_lexeme == "‘horseshoe’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |> 
  filter(feature_id == 36) |>  # First filter by feature_id
  filter(feature_lexeme == "‘teardrop’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |> 
  filter(feature_id == 36) |>  # First filter by feature_id
  filter(feature_lexeme == "‘horn’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |> 
  filter(feature_id == 36) |>  # First filter by feature_id
  filter(feature_lexeme == "‘whortleberry’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |> 
  filter(feature_id == 36) |>  # First filter by feature_id
  filter(feature_lexeme == "‘eyebrow’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |> 
  filter(feature_id == 36) |>  # First filter by feature_id
  filter(feature_lexeme == "‘grease’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |> 
  filter(feature_id == 36) |>  # First filter by feature_id
  filter(feature_lexeme == "‘cattail’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |> 
  filter(feature_id == 36) |>  # First filter by feature_id
  filter(feature_lexeme == "‘honeycomb’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
