---
title: "Stative verb ‘be’: negative present"
author: "Timur Maisak"
date: 2025-08-28
format: html
css: styles.css
...
In the negative present, stative verbs employ the suffix which is identical to the negative present-tense copula. It is *-diš* in the majority of varieties (e.g. *a-diš* ‘is not there’), and *-ǯiš* in Shinaz.
...
lexeme_data <- db |> 
  filter(feature_id == 159) |>  # First filter by feature_id
