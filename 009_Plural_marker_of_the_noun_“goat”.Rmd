---
title: Plural marker of the noun “goat”
...
The singular form is cʼihʲ or cʼij. The plural can be formed with suffixes -ler (and its phonetic variants), -er (and its phonetic variants), -e and also -mar (attested only in Kufa). The corresponding forms are the following (only one phonetic variant is given, there are more): cʼuhuler, cʼiher, cʼihe and cʼijmar.
