...
Most indicative verb forms in Rutul are periphrastic and include a lexical verb and a postposed auxiliary.  The present habitual form consists of the imperfective converb with the suffix *-r*/*-re*/*-ri* and the copula *i* (in the short form). Suffix *-j* in Shinaz is equivalent to *-r* in the other varieties.
...
feature_data <- db |> 
  filter(feature_id == 156) |>  # Filter by feature_id
