...
The map shows the form of the enclitic used to mark the standard of comparison Z in equative (‘X is as Y as Z’) and similative (‘X does Y like Z’) constructions. In all villages, the marker is based on cognates of the same marker.


## equative: as strong as a bull {.tabset .tabset-fade .tabset-pills}
...
## similative: walks like a bear {.tabset .tabset-fade .tabset-pills}
