---
title: Plural marker of the noun ‘sister’
...
The singular absolutive of the noun ‘sister’ is *riši*. The map shows the marker that is used in plural absolutive. The attested variants include: *-jma* (attested only in Khnov) and *-jmar* (elsewhere).
