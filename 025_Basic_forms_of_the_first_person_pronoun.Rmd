---
title: Basic forms of the first person pronoun
author: Ilya Sadakov
...
Two maps show the absolutive and the ergative forms of the first person singular pronoun 'I'.


## I.ABS {.tabset .tabset-fade .tabset-pills}

### Map

```{r}
db |> 
  filter(feature_lexeme == 'I.ABS')  |>
  filter(!is.na(value),
         value != 'NO DATA') |>
...
## I.ERG {.tabset .tabset-fade .tabset-pills}

### Map

```{r}
db |> 
  filter(feature_lexeme == 'I.ERG')  |>
  filter(!is.na(value),
         value != 'NO DATA') |>
  mutate(value = str_split(value, ' ; ')) |> 
  unnest_longer(value) |> 
