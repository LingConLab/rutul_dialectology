...
The map shows lexical items for the concept ‘very’. The context elicited: ‘Madina is a very beautiful girl’.
...
feature_data <- db |> 
  filter(feature_id == 91) |>  # Filter by feature_id
