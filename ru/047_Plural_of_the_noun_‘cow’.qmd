...
The singular absolutive of the noun ‘cow’ varies as following: *zer*,  *zʲer*, *zär* and *zʲär* (see [feature](https://lingconlab.github.io/rutul_dialectology/027_Phonetic_variation_in_the_lexical_item_%E2%80%98cow%E2%80%99.html)). The plural absolutive is irregular in that it loses /r/ of the root: *zebɨr* (and its phonetic variants: *zʲebɨr*, *zʲäbɨr*) and *zʲebir* / *zebir*. The map shows the variation in plural forms.
...
feature_data <- db |> 
  filter(feature_id == 47) |>  # Filter by feature_id
