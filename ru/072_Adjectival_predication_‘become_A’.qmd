---
title: "Adjectival predication ‘become A’"
author: "Ilya Sadakov"
date: 2025-08-28
format: html
lang: ru
...
lexeme_data <- db |>
  filter(feature_id == 72) |>  # First filter by feature_id
  filter(feature_lexeme == "‘The apple became red’") |>  # Then filter by feature_lexeme
...
lexeme_data <- db |>
  filter(feature_id == 72) |>  # First filter by feature_id
  filter(feature_lexeme == "‘The woman became good’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
