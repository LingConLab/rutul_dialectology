...
lexeme_data <- db |>
  filter(feature_id == 34) |>  # First filter by feature_id
  filter(feature_lexeme == "‘father’") |>  # Then filter by feature_lexeme
...
lexeme_data <- db |>
  filter(feature_id == 34) |>  # First filter by feature_id
  filter(feature_lexeme == "‘apple’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
