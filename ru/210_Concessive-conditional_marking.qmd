---
title: "Concessive-conditional marking"
...
Concessive-conditional clauses are derived uniformly across the dialects --- by attaching the additive to the conditional converb.
...
feature_data <- db |> 
  filter(feature_id == 210) |>  # Filter by feature_id
