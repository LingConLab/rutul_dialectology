...
lexeme_data <- db |>
  filter(feature_id == 66) |>  # First filter by feature_id
  filter(feature_lexeme == "‘twenty’ /ɢaːd/") |>  # Then filter by feature_lexeme
...
lexeme_data <- db |>
  filter(feature_id == 66) |>  # First filter by feature_id
  filter(feature_lexeme == "‘ram’ /ɢarg/") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 66) |>  # First filter by feature_id
  filter(feature_lexeme == "‘eyebrow’ /ɢač/") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 66) |>  # First filter by feature_id
  filter(feature_lexeme == "‘burdock’ /paɢʷal/") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 66) |>  # First filter by feature_id
  filter(feature_lexeme == "‘village’ /muˁɢ/") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
