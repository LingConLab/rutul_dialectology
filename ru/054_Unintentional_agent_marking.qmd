...
We elicited the two contexts ‘I (unintentionally) broke a cup’ and ‘Rasul (unintentionally) broke a screwdriver’. The maps show the case marking on the pronoun ‘I’ and the proper name ‘Rasul’. The attested variants include: *-da* / *-dɨ* / *-dda* / *-daː* and *-dɨgɨr* / *-dɨgɨ* / *-dɨga* (the latter attested only in Khnov).
...
lexeme_data <- db |>
  filter(feature_id == 54) |>  # First filter by feature_id
  filter(feature_lexeme == "‘Rasul’") |>  # Then filter by feature_lexeme
