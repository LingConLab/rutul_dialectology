---
title: "Imperative interjection ‘here, take it!’"
author: "Ilya Sadakov"
date: 2025-08-28
format: html
lang: ru
...
The map shows the form of the imperative interjection used when passing something to the addressee. Two stimuli were used — ‘Here, take the money! Here, take the bread!’, and they both showed the same result in each village: the form *ma*.
...
feature_data <- db |> 
  filter(feature_id == 86) |>  # Filter by feature_id
