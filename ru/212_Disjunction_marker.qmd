...
The disjunction of NPs ("X or Y") is expressed either by a separate particle, or by a construction with some form of the verb 'want' ("Want to do X --- then do X; want to do Y, then do Y").
...
feature_data <- db |> 
  filter(feature_id == 212) |>  # Filter by feature_id
