---
title: "Adjectival predication ‘be A’"
author: "Ilya Sadakov"
date: 2025-08-28
format: html
lang: ru
...
lexeme_data <- db |>
  filter(feature_id == 71) |>  # First filter by feature_id
  filter(feature_lexeme == "‘The apple is red’") |>  # Then filter by feature_lexeme
...
lexeme_data <- db |>
  filter(feature_id == 71) |>  # First filter by feature_id
  filter(feature_lexeme == "‘The woman is good’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
