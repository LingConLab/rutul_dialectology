...
lexeme_data <- db |>
  filter(feature_id == 182) |>  # First filter by feature_id
  filter(feature_lexeme == "jaχ.run.IMP") |>  # Then filter by feature_lexeme
...
lexeme_data <- db |>
  filter(feature_id == 182) |>  # First filter by feature_id
  filter(feature_lexeme == "suχ.run.IMP") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 182) |>  # First filter by feature_id
  filter(feature_lexeme == "k.give.IMP") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 182) |>  # First filter by feature_id
  filter(feature_lexeme == "ij.give.IMP") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 182) |>  # First filter by feature_id
  filter(feature_lexeme == "lie.IMP") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 182) |>  # First filter by feature_id
  filter(feature_lexeme == "start.IMP") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 182) |>  # First filter by feature_id
  filter(feature_lexeme == "write.IMP") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 182) |>  # First filter by feature_id
  filter(feature_lexeme == "cry.IMP") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 182) |>  # First filter by feature_id
  filter(feature_lexeme == "stand.IMP") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 182) |>  # First filter by feature_id
  filter(feature_lexeme == "see.IMP") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 182) |>  # First filter by feature_id
  filter(feature_lexeme == "die.IMP") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 182) |>  # First filter by feature_id
  filter(feature_lexeme == "go.IMP") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
