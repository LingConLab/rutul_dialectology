...
lexeme_data <- db |>
  filter(feature_id == 139) |>  # First filter by feature_id
  filter(feature_lexeme == "Affirmative form: PFV.ATTR + COP") |>  # Then filter by feature_lexeme
