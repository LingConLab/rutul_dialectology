---
title: "Negative present habitual"
...
Most indicative verb forms in Rutul are periphrastic and include a lexical verb and a postposed auxiliary. The form of the negative present habitual consists of the imperfective converb and the negative copula *diš* (e.g. *deʔer-diš* ‘does not smoke’). In Shinaz, a phonological shift to *ǯiš* took place.
...
feature_data <- db |> 
  filter(feature_id == 151) |>  # Filter by feature_id
