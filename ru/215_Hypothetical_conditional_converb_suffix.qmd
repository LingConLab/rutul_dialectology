---
title: "Hypothetical conditional converb suffix"
...
The suffix for the hypothetical conditional converb ("If X, then Y").
...
feature_data <- db |> 
  filter(feature_id == 215) |>  # Filter by feature_id
