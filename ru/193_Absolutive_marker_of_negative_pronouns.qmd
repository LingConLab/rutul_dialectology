---
title: "Absolutive marker of negative pronouns"
...
The feature shows great variance in form of the absolutive suffix. While the variant -*ne* / -*nä* is used by many speakers in different villages, many others are attested as well: -*nen* in Ikhrek, -*nɨ* in Myukhrek, -*na* in Kina, -*nik* in Shinaz, -*ni* and -*neki* / -*näki* in different villages.
...
feature_data <- db |> 
  filter(feature_id == 193) |>  # Filter by feature_id
