---
title: "Expression of the spatial meaning ‘from the top of’"
...
We elicited the context ‘The frog got off the rock’. The map shows the marking on the noun ‘rock’. The attested variants include: *-Vːla* / *-Vːlɨ* / *-aːl* (long vowel), *-Vla* / *-Vlɨ* (short vowel) and *-ja* (attested only in Ikhrek).
...
feature_data <- db |> 
  filter(feature_id == 15) |>  # Filter by feature_id
