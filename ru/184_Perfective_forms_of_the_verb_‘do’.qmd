...
lexeme_data <- db |>
  filter(feature_id == 184) |>  # First filter by feature_id
  filter(feature_lexeme == "Gender 2 of the perfective form of the verb ‘do’") |>  # Then filter by feature_lexeme
...
lexeme_data <- db |>
  filter(feature_id == 184) |>  # First filter by feature_id
  filter(feature_lexeme == "Gender1 of the perfective form of the verb ‘do’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 184) |>  # First filter by feature_id
  filter(feature_lexeme == "Gender 3 of the perfective form of the verb ‘do’") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
