---
title: "Expression of the spatial meaning ‘in contact on top of’"
...
We elicited the context ‘There is a stain on the table’. The map shows the case marking on the noun ‘table’. The attested variants include: *-k* / *-kʲ*, *-a*, *-j* (in Ikhrek) and *-xde* (attested with only one consultant, in Kiche).
...
feature_data <- db |> 
  filter(feature_id == 18) |>  # Filter by feature_id
