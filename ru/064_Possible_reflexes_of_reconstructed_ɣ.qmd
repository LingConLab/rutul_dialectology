...
lexeme_data <- db |>
  filter(feature_id == 64) |>  # First filter by feature_id
  filter(feature_lexeme == "‘firefly’ /rabɣantʼej/") |>  # Then filter by feature_lexeme
...
lexeme_data <- db |>
  filter(feature_id == 64) |>  # First filter by feature_id
  filter(feature_lexeme == "‘husband’ /wɨɣɨl/") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 64) |>  # First filter by feature_id
  filter(feature_lexeme == "‘lamb stomach’ /ɣɨrɨɣ/") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 64) |>  # First filter by feature_id
  filter(feature_lexeme == "‘snake’ /ɣar/") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 64) |>  # First filter by feature_id
  filter(feature_lexeme == "‘sun’ /wirɨɣ/") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 64) |>  # First filter by feature_id
  filter(feature_lexeme == "‘tasting musty’ /ɣɨrɣɨm(a)dɨ/") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |>
  filter(feature_id == 64) |>  # First filter by feature_id
  filter(feature_lexeme == "‘wild oat’ /ɣarɣal|r/") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
