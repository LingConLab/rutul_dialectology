...
lexeme_data <- db |> 
  filter(feature_id == 68) |>  # First filter by feature_id
  filter(feature_lexeme == "‘enemy’ /dušman/") |>  # Then filter by feature_lexeme
...
lexeme_data <- db |> 
  filter(feature_id == 68) |>  # First filter by feature_id
  filter(feature_lexeme == "‘help’ /kümäg/") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |> 
  filter(feature_id == 68) |>  # First filter by feature_id
  filter(feature_lexeme == "‘mirror’ /güzge/") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
...
lexeme_data <- db |> 
  filter(feature_id == 68) |>  # First filter by feature_id
  filter(feature_lexeme == "‘straight’ /düzdɨ/") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
