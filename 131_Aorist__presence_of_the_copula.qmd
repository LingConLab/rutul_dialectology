---
title: "Aorist: presence of the copula"
...
Depending on the variety, the short copula *i* may be present or absent in the affirmative Aorist. In Amsar, the copula is consistently absent, as confirmed by both informants. Across other settlements, no consistency is observable. For Khnov, the value of this feature is marked as “OTHER”, because the long copula *-iʔi* is used, with the converb marker *-r* being omitted.
...
feature_data <- db |> 
  filter(feature_id == 131) |>  # Filter by feature_id
