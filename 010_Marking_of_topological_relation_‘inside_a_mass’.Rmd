...
We elicited the context ‘There are a lot of fish in the water’. The map shows the case marking on the noun ‘water’. The attested variants include: CASE1 — *-a* / *-e* / ZERO (*xij-e* in Kina, *xid-a* / *šid-a* in Khnov and *xi* in Kala), CASE2 — *-xde* / *-šde* (*xidi-xde* / *xidi-šde* in Kiche and *xidɨ-xde* / *xidɨ-šde* in Kufa) and CASE3 — *-kʲ* / *-k* (elsewhere, various forms: *xidɨ-k*, *xi-k*, *xiji-kʲ*, etc). The full forms of the noun are given in brackets. While the oblique stems may vary across villages, these differences are not considered in this particular feature. For variation in oblique stem formation, see @feature.
