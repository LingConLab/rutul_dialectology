---
title: "Alternative concessive conditionals"
...
The construction for the expression of alternative concessive conditional semantics ("Whether X or not X, Y"). It usually required two clauses, one of them being affirmative and one negative. Those clauses may be conditional converbs, or general converbs; in some cases, they are coordinated by additive particles. In this feature, we encode the form of the subordinate clause.
...
feature_data <- db |> 
  filter(feature_id == 208) |>  # Filter by feature_id
