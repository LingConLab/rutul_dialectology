---
title: "Expression of the meaning ‘at least’"
author: "Ilya Sadakov"
date: 2025-08-28
format: html
css: styles.css
...
feature_data <- db |> 
  filter(feature_id == 81) |>  # Filter by feature_id
