...
The singular absolutive of the noun ‘goat’ is either *cʼihʲ* or *cʼij* (see feature @). The plural absolutive can be either regular: *cʼiher*, *cʼihe* and *cʼijmar* (and their phonetic variants) or irregular: *cʼuhuler* (and its phonetic variants). Depending on the village, in our data only the regular forms are attested, only irregular ones, or both types of forms may coexist.
