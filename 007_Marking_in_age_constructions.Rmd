...
We elicited the context ‘I am 20 years old’. This map shows which marker is used on the human NP referring to the person whose age is predicated (in our case, first person singular pronoun). Variants include *-dɨ* / *-d* (attributive marker) or *-χda*.
