---
title: Copula, past tense suffix
author: Nastya Ivanova
date: 'Last update: `r lubridate::make_datetime(year = 2023, month = 12, day = 12)`'
output:
  html_document:
...
In the past tense, the affirmative copula is marked with the past tense suffix -j in the majority of varieties (e.g. jiʔi-j ‘was’). In Khnov, the past tense suffix is -na (e.g. jiʔi-na).
