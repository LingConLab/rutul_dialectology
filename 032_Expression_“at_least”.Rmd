...
The map shows the means of expressing the meaning ‘at least’. The distinction is made between three non-cognate words, HADANA (and its variants haadan / hadan / dan), BET (and its variant pet) and MAN. A special construction with the verbal form JIŠIJNE (literally ‘if become’) was attested in Khnov. The relatively frequent alternative Russian χotʲa bɨ ‘at least’ as well as occasional replies meaning ‘somehow’, ‘a few’, etc. were coded as OTHER.
