...
Ergative marker can be of r-type (*balʁu-ra* fish.OBL-ERG) or of vowel-type (*gagaj-e* uncle-ERG). In each case the vowel in the marker can be present (*balʁu-ra* fish.OBL-ERG, *gagaj-e* uncle-ERG) or absent (*balʁu-r* fish.OBL-ERG, *gagaj-Ø* uncle-ERG). We collected 6 sentences with three nouns in singular and in plural: uncle.SG and uncle.PL (animate, human), fish.SG and fish.PL (animate, non-human), river.SG and rock.PL (inanimate, non-human). The sentences are the following: ‘(My) uncle helped me build a house’, ‘(My) uncles helped me build a house’, ‘The fish (SG) ate the fly’, ‘The fish (PL) ate the flies’, ‘The river demolished the bridge’, ‘The rocks broke the roof’. In these maps the presence of the vowel in ergative marker is shown in these 6 contexts.
