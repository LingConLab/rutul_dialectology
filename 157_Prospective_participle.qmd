...
The prospective participle is derived from the infinitive by means of the attributive marker *-dɨ*. We observed no variation in this feature across Rutul varieties.
...
feature_data <- db |> 
  filter(feature_id == 157) |>  # Filter by feature_id
