---
title: Marking of topological relation ‘from inside a mass’
...
We elicited the context ‘Musa catched all the fish out of the water’. The map shows the case marking on the noun ‘water’. The attested variants include: *-kla* / *-kʲla*, *-ka* (attested only in Ikhrek), *-ɨgɨ* / *-ɨgɨr* (attested only in Khnov), *-a* and *-ɨːla*.
