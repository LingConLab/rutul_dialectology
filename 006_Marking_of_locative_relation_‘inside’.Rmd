---
title: Marking of locative relation ‘inside’
...
These maps show what marker is used on a noun denoting locative relation ‛inside’: ‘in the house’ and ‘in the byre’. The markers can be following: -a (in case of a ‘hard’ stem, ‘house’), -e / -ä (‘soft’ stem, ‘byre’), and also in both cases the marker can be omitted, zero marking. The sentence, which were elicitated: ‘I am at home’ and ‘Cow is in the byre’.


## byre {.tabset .tabset-fade .tabset-pills}

### Map

```{r}
db |> 
  filter(feature_lexeme == 'byre')  |>
  filter(!is.na(value),
         value != 'NO DATA') |>
