---
title: Adverbial marker as functive
author: Ilya Sadakov
...
The map shows whether the adverbial marker -na can be used to express functive meaning (‘serving as X’). When -na was not allowed, an abstract noun derivation with inessive marker (‘in X-hood’) was used.
