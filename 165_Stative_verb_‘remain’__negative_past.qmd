---
title: "Stative verb ‘remain’: negative past"
...
In the negative past, the stative verbs take the past tense suffix *-ij* in the majority of varieties (e.g. *mardiš-ij* ‘did not remain’). In Khnov, the past tense suffix is -na (e.g. *mardiš-na*).
...
feature_data <- db |> 
  filter(feature_id == 165) |>  # Filter by feature_id
