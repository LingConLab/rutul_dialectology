...
Personal lative (going to X's place) can be marked by spatial forms  -χda /-χdɨ / -χd 'POST/SUB' or -k 'INTER/CONT', specialized marker -χdal (Khnov) or by means of postpositional phrase -dɨ bejda 'near X'.
