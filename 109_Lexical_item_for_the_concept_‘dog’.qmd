---
title: Lexical item for the concept ‘dog’
...
The map shows which lexical item is used for the concept ‘dog’. The attested variants include: *χij* (attested only in Khnov) and *tɨla* / *tala* (elsewhere).
