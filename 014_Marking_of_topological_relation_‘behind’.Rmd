---
title: Marking of topological relation ‘behind’
author: Asya Alekseeva
date: 'Last update: `r lubridate::make_datetime(year = 2024, month = 2, day = 10)`'
output:
  html_document:
...
We elicited the context ‘The children hid behind the house’. The map shows the marking on the noun ‘house’. The attested variants include: case marker *-χda* and attributive form of a noun with spatial postpositions — *-dɨ jɨˁqʼaχda* / *-dɨ jɨˁqʼaχdɨ*, *-dɨ quʔuna* / *-dɨ quna*, *-dɨ xala*, *-dɨ jɨˁqʼada*, *-dɨ giraʁdɨ*.
