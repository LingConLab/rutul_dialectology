---
title: Marking of topological relation ‘towards inside a mass’
...
We elicited the context ‘I added (some) flour into the dough’. The map shows the case marking on the noun ‘dough’. The attested variants include: *-k* / *-kʲ* and *-šdä* (attested with only one consultant, in Kiche).
