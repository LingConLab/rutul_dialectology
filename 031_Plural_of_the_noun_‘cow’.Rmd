...
date: 'Last update: `r lubridate::make_datetime(year = 2024, month = 2, day = 6)`'
output:
  html_document:
...
The singular absolutive of the noun ‘cow’ varies as following: *zer*,  *zʲer*, *zär* and *zʲär* (see feature @). The plural absolutive is irregular in that it loses /r/ of the root: *zebɨr* (and its phonetic variants: *zʲebɨr*, *zʲäbɨr*) and *zʲebir* / *zebir*. The map shows the variation in plural forms.
