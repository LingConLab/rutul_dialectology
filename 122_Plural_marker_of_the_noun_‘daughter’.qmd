---
title: Plural marker of the noun ‘daughter’
...
The singular absolutive of the noun ‘daughter’ is *rɨš*. The map shows the marker that is used in plural absolutive. The attested variants include:  *-ib* / *-ɨb* (Myukhrek and Dzhilikhur), *-bir*  (Khnov), *-bi* / *-bɨ* (Amsar), *-bä* / *-bäh* (Luchek) and *-be* (elsewhere).
