...
We elicited the context ‘My house is near the river’. The map shows the marking on the noun ‘river’. The attested variants include: noun in attributive form and postpositions *bejda* / *bejdɨ* / *begede*, *surudɨ* and *janda* — *-dɨ bejda* / *-dɨ bejdɨ* / *-dɨ begede*, *-dɨ surudɨ* (attested only in Luchek), *-dɨ janda* (attested only in Khnov), CASE1 — *-da* / *-dɨ* / *-de* / *-d* and CASE2 — *-a* (attested only in Khnov).
