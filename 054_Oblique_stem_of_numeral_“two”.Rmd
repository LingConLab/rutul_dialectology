---
title: Oblique stem of numeral “two”
author: Ilya Sadakov
...
The map shows the form of oblique stem of numeral ‘two’ in the ergative and the superelative.


## two.ERG {.tabset .tabset-fade .tabset-pills}

### Map

```{r}
db |> 
  filter(feature_lexeme == 'two.ERG')  |>
  filter(!is.na(value),
         value != 'NO DATA') |>
...
## two.ATTR {.tabset .tabset-fade .tabset-pills}

### Map

```{r}
db |> 
  filter(feature_lexeme == 'two.ATTR')  |>
  filter(!is.na(value),
         value != 'NO DATA') |>
  mutate(value = str_split(value, ' ; ')) |> 
  unnest_longer(value) |> 
