...
The perfective participle is derived from the perfective stem by means of the attributive marker *-d*. We observed no variation in this feature across Rutul varieties.
...
feature_data <- db |> 
  filter(feature_id == 153) |>  # Filter by feature_id
