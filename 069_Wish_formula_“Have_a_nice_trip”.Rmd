...
The most frequent formula used as a farewell wish is constructed from the words ‘good way’ and the verb ‘be’ in the optative (‘good way may be’). More rarely a formula containing the Azerbaijani uɣur ‘luck’ is used or a wish which literally means ‘open way may be’.
