...
The plural marker of the word “brother” is shown in the map. It can be either irregular (šu (SG) - šube / šubä / etc. (PL), different phonetic variants), either using plural marker -jmar or -jer (not very productive plural suffixes, but they are used for some lexemes). In Shinaz the form šugu-jmar is used, because the singular form is sugu (cf. šu in other dialects).
