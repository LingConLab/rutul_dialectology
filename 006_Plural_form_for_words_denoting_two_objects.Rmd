---
title: Plural form for words denoting two objects
...
These maps show which plural form is used for words denoting two objects (legs and eyes). It can be either with suffix -ɨr (ʁilabɨr and ulabɨr), an allomorph of suffix -bɨr usually used to form plural forms (χal (house.SG) - χalbɨr (house.PL)) , either without this suffix (ʁilab and ulab) with stem formant -ab (cf. singular forms of these words: ʁil and ul). We show here the first reaction of speakers and their opinion upon the opposite variant (if a form ʁilabɨr was given, we ask if it is possible to use ʁilab).
