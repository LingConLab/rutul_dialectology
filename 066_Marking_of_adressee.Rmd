---
title: Marking of adressee
author: Kostya Filatov
date: 'Last update: `r lubridate::make_datetime(year = 2022, month = 5, day = 21)`'
output:
  html_document:
...
Adressee can be marked in Rutul dialects by means of 'POST/SUB' marker -χda (Kiche) or 'APUD' marker -da / -de / -dɨ / -dda / -d  elsewhere.
