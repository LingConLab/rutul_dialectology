...
We asked two contexts with predicative possessors: ‘Fatima has two children’ (affirmative) and ‘Rasul does not have a car’ (negative). These maps show the markers used on ‘Fatima’ and ‘Rasul’ in these contexts: *-χda*, *-χdɨ* or *-d* (attested only once, in Amsar).
