---
title: 'ergative marker vowel variation: uncle.PL'
...
db <- read_csv('data/database.csv')  %>% filter(feature_id == 17)
...
Is it possible to add or to eliminate vowel in ergative marker (depending on the form of the first reaction) in uncle.PL?
