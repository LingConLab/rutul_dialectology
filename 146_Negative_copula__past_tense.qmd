---
title: "Negative copula: past tense"
author: "Timur Maisak"
date: 2025-08-28
format: html
css: styles.css
...
In the past tense, the negative copula is marked with the past tense suffix *-ij* all varieties except Khnov (e.g. *diš-ij* ‘was not’). In Khnov, the past tense suffix is *-na* (e.g. *diš-na*).
...
feature_data <- db |> 
  filter(feature_id == 146) |>  # Filter by feature_id
