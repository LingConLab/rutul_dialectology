---
title: Plural marker of the noun ‘son’
...
The singular absolutive of the noun ‘son’ is *duχ*. The map shows the marker that is used in plural absolutive. The attested variants include: *-rä* (attested in Luchek and Kiche), *-ra* (in Ikhrek, Myukhrek, Dzhilikhur and Khnov) and *-re* (elsewhere).
