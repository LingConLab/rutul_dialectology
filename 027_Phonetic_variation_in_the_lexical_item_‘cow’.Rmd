---
title: Phonetic variation in the lexical item ‘cow’
author: Asya Alekseeva
date: 'Last update: `r lubridate::make_datetime(year = 2024, month = 2, day = 1)`'
output:
  html_document:
...
The map shows phonetic variation in the absolutive singular of ‘cow’. The attested forms are *zer*, *zʲer*, *zär* and *zʲär*.
