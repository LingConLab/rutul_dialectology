---
title: Ergative marker in “I-ERG you-ABS”
author: Ilya Sadakov
...
db <- read_csv('data/database.csv') |> filter(feature_id == 10)
villages <- read_csv('data/villages.csv')
```

In the context with the ergative 1st person participant and the absolutive 2nd person participant ('I-ERG you-ABS'), is the ergative case marker zero, overt, or it varies?
