---
title: Marking of topological relation ‘in contact with’
...
We elicited the context ‘The painting is on the wall’. The map shows the case marking on the noun ‘wall’. The attested variants include: *-k* / *-kʲ*, *-χda* / *-χd*, *-χdɨgɨr* (attested with only one consultant, in Khnov), *-a* (attested only in Khnov) and *-ɨ* (attested with only one consultant, in Ikhrek).
