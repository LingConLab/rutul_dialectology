...
lexeme_data <- db |> 
  filter(feature_id == 203) |>  # First filter by feature_id
  filter(feature_lexeme == "absolutive") |>  # Then filter by feature_lexeme
...
lexeme_data <- db |> 
  filter(feature_id == 203) |>  # First filter by feature_id
  filter(feature_lexeme == "ergative") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
