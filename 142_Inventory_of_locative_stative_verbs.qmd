---
title: "Inventory of locative stative verbs"
author: "Timur Maisak"
date: 2025-08-28
format: html
css: styles.css
...
In most Rutul varieties, six locative stative verbs are attested: *a* ‘be (inside)’, *χa* ‘APUD.be’, *ʁa* ‘SUPER.be’, *ki* ‘CONT.be’, *gi* ‘SUB.be’, *qu* ‘POST.be’. In some varieties, one or more of these verbs did not appear in our data. Thus, in Shinaz, the stative *ki* ‘CONT.be’ was not used in translations by both speakers.
...
feature_data <- db |> 
  filter(feature_id == 142) |>  # Filter by feature_id
