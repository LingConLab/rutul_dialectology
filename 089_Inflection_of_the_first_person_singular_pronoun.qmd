---
title: "Inflection of the first person singular pronoun"
author: "Ilya Sadakov"
date: 2025-08-28
format: html
css: styles.css
...
The maps show the absolutive and the ergative forms of the first person singular pronoun ‘I’. For the absolutive the context ‘I am Rutul’ was elicited, and for the ergative — ‘I said so’.
...
lexeme_data <- db |> 
  filter(feature_id == 89) |>  # First filter by feature_id
  filter(feature_lexeme == "I.ABS") |>  # Then filter by feature_lexeme
...
lexeme_data <- db |> 
  filter(feature_id == 89) |>  # First filter by feature_id
  filter(feature_lexeme == "I.ERG") |>  # Then filter by feature_lexeme
  filter(!is.na(value), value != "NO DATA")
